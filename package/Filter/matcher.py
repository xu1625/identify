...
class Matcher:
    ...
    @classmethod
    def match(cls, state_list, measure_list):  # 两个list中单个元素数据结构都是[c_x, c_y, z, yaw, W, H].T
        """
        最大权值匹配
    ...
    def cal_iou(cls, state, measure):
        """
        计算状态和观测之间的IOU
        :param state:ndarray [c_x, c_y, z, yaw, w, h].T
        :param measure:ndarray [c_x, c_y, z, yaw, w, h].T
        :return:
        """
